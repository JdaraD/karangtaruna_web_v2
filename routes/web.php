...
use App\Http\Controllers\admin\sliderUsahaController;
...
Route::livewire('/kategori-detail/{id}', 'pages::user.kategori-detail')->name('kategori-detail');
Route::livewire('/detail-product/{id}', 'pages::user.detail-product')->name('detail-product');
...
Route::livewire('/admin.banner_&_slider', 'pages::admin.banner')->name('admin.banner');
...
Route::post('/admin/sliderUsaha', [sliderUsahaController::class, 'store'])->name('admin.sliderUsaha.store');
