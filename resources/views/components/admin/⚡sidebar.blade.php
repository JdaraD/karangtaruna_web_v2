...
<div x-data="{ activeDropdown: '{{ $defaultDropdown }}' }" class="relative flex min-h-screen bg-gray-100 font-[poppins]">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        class="fixed inset-y-0 left-0 z-50 flex h-screen w-64 flex-col bg-slate-900 text-slate-300 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 shadow-xl border-r border-slate-800">
        
        <!-- Brand / Logo Header (Diam di atas) -->
        <div class="flex h-16 shrink-0 items-center justify-between px-6 bg-slate-950/50 border-b border-slate-800">
        ...
        <!-- Navigation Links (Bagian inilah yang bisa di-scroll secara mandiri) -->
        <div class="flex-1 overflow-y-auto scrollbar-none px-4 py-4 space-y-1 custom-scrollbar">
            ...
            class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all {{ request()->routeIs('admin.news.*') ? 'bg-indigo-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white' }}">
                <x-si-githubsponsors class="w-5 h-5" />
                <span>Sponsor</span>
            </a>
            ...
            <!-- Pengguna / Admin -->
            <a href="{{ route('admin.manajemen-acccount') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-slate-800 hover:text-white transition-all">
            ...
            <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-slate-800 hover:text-white transition-all">
        ...
        <!-- Footer Profile & Logout (Diam di bawah, tidak ikut ter-scroll) -->
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <p class="text-xs text-slate-400 truncate">{{ Auth::user()->email ?? 'admin@katar.id' }}</p>
                    </div>
                </div>
                <!-- Tombol Logout -->
