                        ...
                        <div class="flex w-full h-full flex-col gap-1">
                            <div class="flex gap-1 p-1 justify-between items-center bg-[#618764]/40 rounded-md">
                                ...
                                <div class="flex gap-1">
                                    <button wire:click="btnEdit" class="flex bg-yellow-500 hover:bg-yellow-700 justify-center items-center w-6 h-6 rounded-md shadow-md cursor-pointer" title="Lihat">
                                        <x-bi-pencil class="h-4 w-4 text-white"/>
                                    </button>
                                    <button wire:click="btnDelete" class="flex bg-red-500 hover:bg-red-700 justify-center items-center w-6 h-6 rounded-md shadow-md cursor-pointer" title="Hapus">
            ...
            <div class="flex flex-col w-fit h-fit gap-4 p-4 bg-white rounded-md">
                ...
                <form action="{{ route('admin.news.store') }}" method="POST" class="flex flex-col gap-4" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col w-full gap-5 pt-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2">
                            <label for="news" class="text-sm font-semibold text-gray-800">
                                Isi Berita
                            </label>
    
                            <textarea cols="4" rows="2" name="news" required id="news" placeholder="Masukkan Isi berita" class="md:col-span-3 w-full rounded-md text-black border border-gray-300 bg-gray-100 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"></textarea>
                        </div>
