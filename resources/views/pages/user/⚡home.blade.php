...
<section class="flex flex-col w-full h-full">
                ...
                <div class="flex flex-col lg:w-105 md:w-105 w-92.5 lg:h-62.25 md:h-57.25 h-54.5 bg-[#F5F5F5] shrink-0 rounded-lg overflow-hidden shadow-md hover:scale-102 transition-transform ease-in-out duration-120">
                    ...
                    <div class="flex relative gap-2 px-4 py-4 h-full w-full">
                        <div class="flex w-[34%] h-full rounded-md">
                            <img src="{{ asset('storage/' . $kg->gambar) }}" alt="" class="w-full h-full object-cover rounded-md">
                        </div>
                        <div class="flex flex-col gap-2 w-[66%] h-full">
                            <p class="uppercase font-bold">{{$kg->judul}}</p>
                            <p class="text-xs text-justify font-[poppins] line-clamp-6">{{$kg->deskripsi}}</p>
                        </div>
                        <p class="absolute bottom-0 right-4 text-black text-2xl normal-case font-bold rounded-md">{{$kg->progress}}%</p>
                    </div>
                    <div class="flex justify-center items-center w-full h-[20%] ">
                        <div class="flex w-[90%] h-4 bg-[#9CB080] rounded-full overflow-hidden">
                            <div class="w-[{{$kg->progress}}%] h-full bg-[#618764]"></div>
                        </div>
                    </div>
                </div>
    ...
    {{-- Contact --}}
        ...
        <article class="flex justify-center items-center gap-2 w-full h-full md:mt-4 mt-2">
            <div class="flex flex-wrap gap-4 md:w-[80%] w-[90%] h-full">
                <diV class="flex flex-col gap-4 w-full md:w-[49%] md:h-125 h-auto order-1">

                    <div class="flex flex-col gap-4 w-full md:h-[80%] h-auto bg-white rounded-lg shadow-md px-4 py-2">
