    ...
    <article class="flex flex-col lg:w-[90%] md:w-[90%] w-[90%] h-full md:py-6 py-2 md:gap-6 gap-2">
        ...
        <div class="grid md:grid-cols-4 grid-cols-3 w-full h-full lg:gap-4 md:gap-4 gap-2">
            @foreach ($videos as $video)
                <div class="col-span-1 flex relative flex-col lg:w-82 md:w-80 w-30 lg:h-60 md:h-58 h-28 bg-gray-300 rounded-lg shadow-md hover:scale-102 transition-transform duration-120 ease-in-out">
